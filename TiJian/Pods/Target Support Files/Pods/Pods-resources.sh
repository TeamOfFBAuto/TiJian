...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "RongCloudIMKit/Rong_Cloud_iOS_SDK_v2_3_9_stable/zh-Hans.lproj"
  install_resource "RongCloudIMKit/Rong_Cloud_iOS_SDK_v2_3_9_stable/Emoji.plist"
fi

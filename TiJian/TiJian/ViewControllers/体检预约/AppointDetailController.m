...
- (void)clickToCare
{
    ...
    NSString *webUrl = [NSString stringWithFormat:@"%@%@",SERVER_URL,URL_TIJIANXUZHI];
    
    [MiddleTools pushToWebFromViewController:self weburl:webUrl title:@"体检须知" moreInfo:NO hiddenBottom:NO];
}

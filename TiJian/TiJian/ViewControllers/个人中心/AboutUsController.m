...
//    _aWebview.dataDetectorTypes = UIDataDetectorTypeNone;
    ...
    NSArray *contents = @[@"4006279589",@"mobile@jiruijia.com",@"河马医生是一款私人定制健康体检和健康管理移动应用。通过美国圣路易斯大学医学博士后及专家组对中国健康管理现状及互联网化的研究，解决体检行业存在的体检项目标准化、体检报告看不懂、检后管理服务缺失、健康数据不连贯等多个问题。河马医生针对团体及个人实现一站式的体检项目专业个性化定制、在线预约、检后报告深度解读、在线咨询、复查管理、理疗和就医服务。"];

...
-(UIView *)loginView{
    ...
    label = [[UILabel alloc]initWithFrame:CGRectMake(_loginView.width - arrow.width - 110 - 20, _loginView.height - 20 - 12 + 2, 110, 30) title:@"账户管理、收货地址" font:11 align:NSTextAlignmentRight textColor:DEFAULT_TEXTCOLOR_TITLE];
    [_loginView addSubview:label];

...
- (void)updateDefaultAddress:(UIButton *)sender
{
    ...
    [_request requestWithMethod:YJYRequstMethodPost api:USER_ADDRESS_SETDEFAULT parameters:params constructingBodyBlock:nil completion:^(NSDictionary *result) {
...
- (void)deleteAddress:(int)index
{
    ...
    [_request requestWithMethod:YJYRequstMethodPost api:USER_ADDRESS_DELETE parameters:params constructingBodyBlock:nil completion:^(NSDictionary *result) {
        weakTable.pageNum = 1;
...
- (void)getAddressList
{
    ...
    [_request requestWithMethod:YJYRequstMethodGet api:USER_ADDRESS_LIST parameters:params constructingBodyBlock:nil completion:^(NSDictionary *result) {

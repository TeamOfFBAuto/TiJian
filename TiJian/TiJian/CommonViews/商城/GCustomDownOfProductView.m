...
+(GCustomDownOfProductView*)customViewWithType:(TheDownViewType)theType{
    ...
    GCustomDownOfProductView *aView = [[GCustomDownOfProductView alloc]initWithFrame:CGRectMake(0, 0, DEVICE_WIDTH, 50)];
    aView.backgroundColor = RGBCOLOR(38, 51, 62);
    ...
    if (theType == TheDownViewType_gouwuche) {
        ...
        [_addShopCarBtn setFrame:CGRectMake(aView.frame.size.width-theW, 0, theW, 50)];
        ...
        [aView addSubview:_addShopCarBtn];
        
        CGFloat tw = (aView.frame.size.width-theW)/4;

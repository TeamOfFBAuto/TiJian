...
- (void)showProgress:(float)progress status:(NSString*)string maskType:(SVProgressHUDMaskType)hudMaskType {
    ...
    if(self.alpha != 1 || self.hudView.alpha != 1) {
        ...
        self.hudView.transform = CGAffineTransformScale(self.hudView.transform, 1.5, 1.5);
        ...
        [UIView animateWithDuration:0.15
                         ...
                         animations:^{
                             self.hudView.transform = CGAffineTransformScale(self.hudView.transform, 1/1.5, 1/1.5);
...
- (UIImageView *)imageView {
    if (!_imageView)
        _imageView = [[UIImageView alloc] initWithFrame:CGRectMake(0.0f, 0.0f,35.0f,35.0f)];
